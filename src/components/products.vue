...
<div class="pro" id="products" >
    <div class="container">
        ...
        <div class="row rounded-3">
            ...
            <div class="col-sm-12 col-md-4 col-lg-3 parent rounded-3" v-for="item in filter()" :key="item.id">
                <div class="overlay rounded-3">
                    <span @click="addFav()" ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                        </svg></span>
                    <span @click="addCart()" ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bag-check-fill" viewBox="0 0 16 16">
        ...
        <router-link to="/products"><a target="_blank" style="margin:0px 5px" class="btn btn-blue link">More Products</a></router-link>
    </div>
</div>
</template>
...
import apiUrl from "../json/product.json"
export default {
    name: "products",
    data() {
        return {
